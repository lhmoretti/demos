...
app.post("/mesas", mw.isAllowed([ADMIN]), function (req, res) {
    let mesa = req.body;
...
app.get("/mesas", mw.isAllowed([COCINERO, MOZO]), function (req, res) {
...
app.put("/mesas", mw.isAllowed([ADMIN]), function (req, res) {
    let mesa = req.body;
...
app.delete("/mesas/:id", mw.isAllowed([ADMIN]), function (req, res) {
    let id = req.params.id;
